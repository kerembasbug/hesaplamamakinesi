...
export const metadata = buildMetadata({
    title: "15 Günlük Maaş Farkı Hesaplama 2026",
    description: "Memur ve kamu çalışanları için 15 günlük maaş farkı hesaplama aracı. Ocak ve Temmuz maaş zammı farklarını 2026 katsayılarıyla anında hesaplayın.",
    keywords: ["15 günlük maaş farkı hesaplama", "maaş farkı hesaplama", "memur zam farkı", "14 günlük maaş farkı", "maaş farkı ne kadar"],
    path: "/finans/15-gunluk-maas-farki-hesaplama",
})
        ...
        <div className="max-w-4xl mx-auto">
            <JsonLd
                data={calculatorSchema({
                    name: "15 Günlük Maaş Farkı Hesaplama 2025",
            ...
            <article className="mt-12 prose prose-slate dark:prose-invert max-w-none">
                <TarifeUyarisi yil={2025} konu="memur maaş katsayıları" kaynakAdi="Hazine ve Maliye Bakanlığı" kaynakUrl="https://www.hmb.gov.tr/" />
