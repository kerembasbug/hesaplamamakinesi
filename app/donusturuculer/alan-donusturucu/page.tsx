...
export const metadata = buildMetadata({
    title: "Alan Dönüştürücü - m², Dönüm, Hektar",
    description: "Ücretsiz alan birimi dönüştürücü. Metrekare, dönüm, hektar, dekar, akre ve feet kare arasında anında çevirin. Arazi ve emlak hesapları için ideal.",
    keywords: ["alan dönüştürücü", "metrekare dönüm çevirici", "hektar çevirme", "arazi ölçümü", "alan birimi çevirme"],
    path: "/donusturuculer/alan-donusturucu",
})
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <article className="mt-12 prose prose-slate dark:prose-invert max-w-none">
                ...
                <h2>Türkiye&apos;de Arazi Ölçü Birimleri ve Dönüm Kavramı</h2>
                <p>
                ...
                <h2>Sık Kullanılan Alan Birimleri ve Karşılıkları</h2>
                ...
                <h2>İç Mekan ve Mimari Alan Hesaplamaları</h2>
                <p>
                ...
                <h2>Alan Dönüşümünde Dikkat Edilmesi Gerekenler</h2>
                <ul>
