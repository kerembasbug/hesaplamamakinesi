...
export const metadata = buildMetadata({
    ...
    description: "VKİ hesaplama aracı. Boy ve kilonuza göre vücut kitle indeksinizi hesaplayın; ideal kilo aralığınızı ve obezite risk sınıfınızı ücretsiz görün.",
    keywords: ["vki hesaplama", "vücut kitle indeksi", "bmi hesaplama", "ideal kilo", "obezite hesaplama", "kilo boy oranı"],
    path: "/saglik-spor/vki-hesaplama",
})
    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <article className="mt-12 prose prose-slate dark:prose-invert max-w-none">
                ...
                <h2>VKİ Nasıl Hesaplanır? Formül ve Mantık</h2>
                <p>
                ...
                <h2>Yaş Gruplarına Göre İdeal VKİ Değerleri</h2>
                <p>
                ...
                <h2>VKİ Kategorileri ve Olası Sağlık Riskleri</h2>
                ...
                <h2>VKİ Tek Başına Yeterli mi? Alternatif Ölçümler</h2>
                <p>
                ...
                <h3>Sporcuların VKİ değeri neden yanıltıcı olabilir?</h3>
                <p>
                ...
                <h3>VKİ değerimi nasıl düşürebilirim?</h3>
                <p>
                ...
                <h3>Gebelik döneminde VKİ hesaplanır mı?</h3>
                <p>
