...
export const metadata = buildMetadata({
    title: "Sağlık ve Spor Hesaplama Araçları",
    description: "Ücretsiz sağlık ve spor hesaplama araçları: vücut kitle indeksi, kalori ihtiyacı, ideal kilo, su tüketimi, makro besin ve 1RM hesaplayıcıları.",
        ...
        <div className="max-w-4xl mx-auto">
            <JsonLd
                data={collectionPageSchema(
                    "Sağlık & Spor Hesaplama Araçları",
                    "Ücretsiz sağlık ve spor hesaplama araçları. Vücut kitle indeksi (VKİ), kalori ihtiyacı, ideal kilo, su tüketimi ve makro besin hesaplayıcıları.",
                    "/saglik-spor",
                    (categories.find((c) => c.slug === "saglik-spor")?.tools ?? [])
                        .filter((t) => !t.externalUrl)
                        .map((t) => ({ name: t.name, path: `/saglik-spor/${t.slug}`, description: t.description }))
                )}
            />
            <Breadcrumb items={[
                { name: category.name },
            ...
            <article className="prose prose-slate dark:prose-invert max-w-none">
                ...
                <h2>Neden Sağlık Hesaplama Araçları Kullanmalısınız?</h2>
                <ul>
                ...
                <h2>Popüler Sağlık Hesaplayıcılarımız</h2>
                ...
                <h2>Kalori İhtiyacı Hesaplama</h2>
                <p>
                ...
                <h3>Günde kaç litre su içmeliyim?</h3>
                <p>
                ...
                <h3>Kilo vermek için günde kaç kalori almalıyım?</h3>
                <p>
                ...
                <h3>Bazal metabolizma hızı nedir?</h3>
                <p>
